...
- Average retrieval latency: **681.6 ms**
- Average token reduction vs full source context: **20.9%**

| Case | Layer | Pass | Latency ms | Retrieved tokens | Token reduction | Missing / Error |
| --- | --- | --- | ---: | ---: | ---: | --- |
| E01 | short_term | PASS | 0.1 | 133 | 0.0% |  |
| E06 | semantic | PASS | 436.0 | 148 | 67.8% |  |
| E09 | long_term | PASS | 1404.1 | 605 | 0.0% |  |
| E10 | short_term | PASS | 0.3 | 195 | 0.0% |  |
| E02 | long_term | PASS | 1024.4 | 808 | 0.0% |  |
| E03 | long_term | PASS | 1062.6 | 804 | 0.0% |  |
| E04 | episodic | PASS | 253.4 | 153 | 30.8% |  |
| E05 | episodic | PASS | 235.7 | 127 | 42.5% |  |
| E07 | mixed | PASS | 1438.7 | 485 | 14.2% |  |
| E11 | semantic | PASS | 546.6 | 146 | 74.2% |  |
| E08 | long_term | PASS | 1095.6 | 805 | 0.0% |  |
...
`<USER_SUMMARY> For the company project BLUEBIRD-42, the backend must use TypeScript with NestJS, and Python is not to be used for this project's backend. Python is preferred for personal demos such as ORCHID-27. The user needs to complete a benchmark report before Saturday at 16:00 for an open loop LAB-REPORT-1600.  Minh likes Python and dislikes Java. The user's personal project is named ORCHID-27. The user needs to complete a benchmark report before Saturday at 16:00.  When explaining code, use short examples. Prioritize Python and avoid Java. When explaining async/await, use a timeline to illustrate coroutines versus Tasks. The assistant will prioritize timelines when explaining coroutine`
